...
const FLAGS = [
  { country: 'Jamaica', flag: 'https://flagcdn.com/w160/jm.png', position: { top: '-1%', left: '30%' }},
  { country: 'Nigeria', flag: 'https://flagcdn.com/w160/ng.png', position: { top: '-1%', right: '30%' }},
  ...
  { country: 'Liberia', flag: 'https://flagcdn.com/w160/lr.png', position: { top: '75%', left: '2%' } },
